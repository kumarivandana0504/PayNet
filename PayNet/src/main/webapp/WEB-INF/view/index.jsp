                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-2">
                                <div class="logo">
                                    <a href="index.html"><img src="/resources/static/assets/img/logo/" alt=""></a>
                                </div>
                            </div>
                                    ...
                                    <div class="main-menu d-none d-lg-block">
                                        <nav>
                                            <ul id="navigation">                                                                                          
                                                ...
                                                <li><a href="${pageContext.request.contextPath}/wallet.jsp">Wallet</a></li>
                                                <li><a href="/transfer">Transfer</a></li>
                                                <li><a href="/topup">Add Money</a>
                                                </li>
                                                <li><a href="contact.html">History</a></li>
                                                <!-- Button -->
                                                <li class="button-header margin-left "><a href="/registration" class="btn">Sign Up</a></li>
                                                <li class="button-header"><a href="/login" class="btn3">Log In</a></li>
                                            </ul>
                                        </nav>
                                    </div>
                                </div>
    ...
    <main>
        ...
        <div class="slider-area slider-bg ">
                        ...
                        <div class="row align-items-center justify-content-between">
                            <div class="col-xl-5 col-lg-5 col-md-9 ">
                                <div class="hero__caption">
                                    <span data-animation="fadeInLeft" data-delay=".3s">Best Website for Money Transfer</span>
                                    <h1 data-animation="fadeInLeft" data-delay=".6s ">PayNet Transfer</h1>
                                    <p data-animation="fadeInLeft" data-delay=".8s">
                                        A Secure Website to transfer money with your family and friends. </p>
                                    <!-- Slider btn -->
                                    <div class="slider-btns">
                                        <!-- Hero-btn -->
                                        <a data-animation="fadeInLeft" data-delay="1s" href="register.html" class="btn radius-btn">Register</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6">
                                <div class="hero__img d-none d-lg-block f-right">
                                    <img src="/resources/static/assets/img/hero/hero_right.png" alt="" data-animation="fadeInRight" data-delay="1s">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-9 ">
                                <div class="hero__caption">
                                    ...
                                    <div class="slider-btns">
                                        <!-- Hero-btn -->
                                        <a data-animation="fadeInLeft" data-delay="1s" href="register.html" class="btn radius-btn">get started</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
            ...
            <div class="slider-shape d-none d-lg-block">
                <img class="slider-shape1" src="/resources/static/assets/img/hero/top-left-shape.png" alt="">
            </div>
        </div>
        <!-- Slider Area End -->
        <!-- Domain-search start -->
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6"">
                    <div class="single-cat">
                        <div class="cat-icon">
                            <img src="/resources/static/assets/img/icon/services1.svg" alt="">
                        </div>
                        <div class="cat-cap">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="single-cat">
                        <div class="cat-icon">
                            <img src="/resources/static/assets/img/icon/services2.svg" alt="">
                        </div>
                        <div class="cat-cap">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="single-cat">
                        <div class="cat-icon">
                            <img src="/resources/static/assets/img/icon/services3.svg" alt="">
                        </div>
                        <div class="cat-cap">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="single-cat">
                        <div class="cat-icon">
                            <img src="/resources/static/assets/img/icon/services4.svg" alt="">
                        </div>
                        <div class="cat-cap">
                            <h5><a href="#">Employee Owned</a></h5>
                            <p>Supercharge your WordPress hosting with detailed website analytics, marketing tools.</p>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="single-cat">
                        <div class="cat-icon">
                            <img src="/resources/static/assets/img/icon/services5.svg" alt="">
                        </div>
                        <div class="cat-cap">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="single-cat">
                        <div class="cat-icon">
                            <img src="/resources/static/assets/img/icon/services6.svg" alt="">
                        </div>
                        <div class="cat-cap">
...
<footer>
    <div class="footer-wrappr " data-background="/resources/static/assets/img/gallery/footer-bg.png">
