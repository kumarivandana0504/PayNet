...
<main class="login-body" data-vide-bg="/resources/static/assets/img/login-bg.mp4">
    <!-- Login Admin -->
  
     <form:form modelAttribute="Transfer" class="form-default" method="POST">      
        <div class="login-form">
            ...
            <div class="form-input">
                <form:label path="sender" class="control-form-label">Sender's mobile</form:label>
				<form:input type="text" class="form-control" name="sender" path="sender" />
            </div>
            <div class="form-input">
                   <form:label path="reciever" class="control-form-label">Reciever's mobile</form:label>
				<form:input type="text" class="form-control" name="reciever" path="reciever" />
            </div>
            <div class="form-input">
                   <form:label path="money" class="control-form-label">Amount</form:label>
				<form:input type="text" class="form-control" name="money" path="money" />
            </div>
